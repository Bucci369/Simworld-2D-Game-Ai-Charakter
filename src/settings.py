...
SIMPLE_WORLD_WIDTH_TILES = 160   # vorher 80
SIMPLE_WORLD_HEIGHT_TILES = 120  # vorher 60
SIMPLE_WORLD_TREE_DENSITY = 0.02 # Bäume pro Tile (0.02 = 2%)
SIMPLE_WORLD_SEED = 42           # Für reproduzierbare Platzierung; None für Zufall
SIMPLE_WORLD_FARMLAND_PATCHES = 3
SIMPLE_WORLD_FARMLAND_RADIUS_RANGE = (4, 7)  # in Tiles
SIMPLE_WORLD_LAKE_RADII = (8, 5)  # kleinerer See (rx, ry) in Tiles
